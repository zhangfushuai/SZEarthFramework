...
@interface SZEarthUARTPeripheral ()


@end

@implementation SZEarthUARTPeripheral
...
//        tempAppDelegate.bluetoothName = peripheral.name;
//        [tempAppDelegate.modifyBluetoothNameVC.tableView reloadData];
    }
}
